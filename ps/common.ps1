...
$list = @{
    ...
    НачатьТранзакцию                               = "Плагины", "plugins\НачатьТранзакцию\src"
    ЗафиксироватьТранзакцию                        = "Плагины", "plugins\ЗафиксироватьТранзакцию\src"
    ОтменитьТранзакцию                             = "Плагины", "plugins\ОтменитьТранзакцию\src"
    СтруктураКонструкторСлишкомМногоКлючей         = "Плагины", "plugins\СтруктураКонструкторСлишкомМногоКлючей\src"
}
