...
2. Настраиваем пользователей
    2.1. Если в базе нет ни одного пользователя, то заводим администратора с полными правами
    2.2. Снимаем у пользователя под которым будет проходить тестирование галочку "Защита от опасных действий"
2. Создаём проект
